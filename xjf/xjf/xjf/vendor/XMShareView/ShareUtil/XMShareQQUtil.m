...
- (void)tencentDidLogin {
    NSDictionary *dic = @{@"access_token" : _tencentOAuth.accessToken, @"openid" : _tencentOAuth.openId};
    [[NSUserDefaults standardUserDefaults] setValue:_tencentOAuth.accessToken forKey:ACCESS_TOKEN_QQ];
    [[NSUserDefaults standardUserDefaults] setValue:_tencentOAuth.openId forKey:OPEN_ID_QQ];
