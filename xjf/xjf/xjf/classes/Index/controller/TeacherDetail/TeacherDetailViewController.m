...
- (void)requestLessonListData:(APIName *)api method:(RequestMethod)method {
    ...
    if (method == GET) {
        ...
        [request startWithSuccessBlock:^(NSData *_Nullable responseData) {
            ...
            for (TalkGridModel *model in sSelf.teacherDetailModel.result.guru_courses) {
...
- (void)setTeacherDetailHeaderView {
    ...
    [self.teacherDetailHeaderView.focusButton addTarget:self action:@selector(focusAction:)
