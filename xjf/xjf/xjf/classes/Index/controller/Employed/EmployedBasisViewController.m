...
@interface EmployedBasisViewController () <UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) TablkListModel *tablkListModel;
@property (nonatomic, strong) NSMutableArray *dataSource;
@end

@implementation EmployedBasisViewController
static NSString *EmployedBasisCell_id = @"EmployedBasisCell_id";
...
- (void)initTabelView {
    ...
    [self.tableView registerClass:[VideoListCell class] forCellReuseIdentifier:EmployedBasisCell_id];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    VideoListCell *cell = [self.tableView dequeueReusableCellWithIdentifier:EmployedBasisCell_id];
