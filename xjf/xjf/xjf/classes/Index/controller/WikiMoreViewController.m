...
@interface WikiMoreViewController ()<UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.navigationItem.title = @"金融百科更多";
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    WikiMoreClassificationCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:WikiMoreCell_Id forIndexPath:indexPath];
