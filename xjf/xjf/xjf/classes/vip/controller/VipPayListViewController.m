...
- (void)initTabelView {
    ...
    [self.tableView registerClass:[VipPayListPageChoiceCell class]
           forCellReuseIdentifier:VipPayListPageChoiceCell_id];
    [self.tableView registerClass:[VipPayListPagePrivilegeCell class]
           forCellReuseIdentifier:VipPayListPagePrivilegeCell_id];
...
//    VipPayListPagePrivilegeCell *cell = [self.tableView
// dequeueReusableCellWithIdentifier:VipPayListPagePrivilegeCell_id];
//    return cell;
//    }
